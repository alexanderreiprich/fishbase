...
INSERT INTO water_quality (inhabitantId, salinity, minTemperature, maxTemperature, minPh, maxPh) VALUES 
((SELECT id FROM inhabitant WHERE name='Neonfisch'), 0, 22, 25, 6.0, 7.0),
((SELECT id FROM inhabitant WHERE name='Guppy') ,0,24,28,6.8,7.8),
((SELECT id FROM inhabitant WHERE name='Platy') ,0,21,27,7.0,8.5),
((SELECT id FROM inhabitant WHERE name='Schwertträger') ,0,22,28,7.0,8.0),
((SELECT id FROM inhabitant WHERE name='Molly') ,0,24,28,7.0,8.2),
((SELECT id FROM inhabitant WHERE name='Kardinalfisch'),0,23,27,5.5,7.0),
((SELECT id FROM inhabitant WHERE name='Zebrabärbling'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Siamesischer Kampffisch'),0,24,30,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Skalar'),0,24,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Diskusfisch'),0,28,30,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Antennenwels'),0,22,25,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Prachtgurami'),0,24,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Kupferfisch'),0,24,27,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Roter von Rio'),0,24,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Schwarzband-Salmler'),0,23,27,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Königssalmler'),0,23,27,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Feuerschwanz'),0,24,27,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Blauer Neon'),0,24,26,5.5,6.5),
((SELECT id FROM inhabitant WHERE name='Roter Neon'),0,26,28,5.0,6.5),
((SELECT id FROM inhabitant WHERE name='Schmetterlingsbuntbarsch'),0,26,30,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Kakadu-Zwergbuntbarsch'),0,24,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Zwergfadenfisch'),0,24,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Marmorierter Panzerwels'),0,22,26,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Panda-Panzerwels'),0,22,25,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Goldener Panzerwels'),0,22,26,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Roter Phantomsalmler'),0,23,27,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Schwarzer Phantomsalmler'),0,23,27,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Kupferroter Sumatrabarbe'),0,24,27,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Sumatrabarbe'),0,24,27,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Marmorierter Beilbauchfisch'),0,24,28,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Roter Beilbauchfisch'),0,24,28,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Zwergkugelfisch'),0,24,28,7.0,7.5),
((SELECT id FROM inhabitant WHERE name='Zwergbuntbarsch'),0,24,28,6.0,7.5);

-- wasserqualitäten pro wirbellose
INSERT INTO water_quality (inhabitantId, salinity, minTemperature, maxTemperature, minPh, maxPh) VALUES
((SELECT id FROM inhabitant WHERE name='Rote Posthornschnecke'),0,18,28,6.5,8.0),
((SELECT id FROM inhabitant WHERE name='Gelbe Posthornschnecke'),0,18,28,6.5,8.0),
((SELECT id FROM inhabitant WHERE name='Turmdeckelschnecke'),0,20,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Apfelschnecke'),0,22,28,6.5,8.0),
((SELECT id FROM inhabitant WHERE name='Blaue Apfelschnecke'),0,22,28,6.5,8.0),
((SELECT id FROM inhabitant WHERE name='Amano-Garnele'),0,20,27,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Rote Zwerggarnele'),0,20,26,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Gelbe Zwerggarnele'),0,20,26,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Blaue Zwerggarnele'),0,20,26,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Bambusgarnele'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Rote Nashorngarnele'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Tiger-Garnele'),0,20,25,6.0,7.2),
((SELECT id FROM inhabitant WHERE name='Bienen-Garnele'),0,20,25,5.5,6.5),
((SELECT id FROM inhabitant WHERE name='Rote Rennschnecke'),0,22,28,6.5,8.0),
((SELECT id FROM inhabitant WHERE name='Zebra-Rennschnecke'),0,22,28,6.5,8.0); 

-- wasserqualitäten pro pflanzen
INSERT INTO water_quality (inhabitantId, salinity, minTemperature, maxTemperature, minPh, maxPh) VALUES
((SELECT id FROM inhabitant WHERE name='Amazonas-Schwertpflanze'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Kleiner Wasserkelch'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Roter Wasserkelch'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Javafarn'),0,20,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Javamoos'),0,18,28,5.5,8.0),
((SELECT id FROM inhabitant WHERE name='Anubias barteri'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Anubias nana'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Vallisneria spiralis'),0,20,28,6.0,8.0),
((SELECT id FROM inhabitant WHERE name='Rotala rotundifolia'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Ludwigia repens'),0,20,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Hornkraut'),0,15,30,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Wasserpest'),0,15,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Brasilianisches Tausendblatt'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Kleefarn'),0,20,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Zwergspeerblatt'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Roter Tigerlotus'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Grüner Tigerlotus'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Bacopa caroliniana'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Bacopa monnieri'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Hygrophila polysperma'),0,20,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Hygrophila corymbosa'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Lilaeopsis brasiliensis'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Eleocharis parvula'),0,20,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Eleocharis acicularis'),0,15,26,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Hemianthus callitrichoides'),0,22,28,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Glossostigma elatinoides'),0,22,28,5.5,7.0),
((SELECT id FROM inhabitant WHERE name='Riccia fluitans'),0,20,28,6.0,7.5),
...
((SELECT id FROM inhabitant WHERE name='Echinodorus tenellus'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Echinodorus ozelot'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Echinodorus red flame'),0,22,28,6.5,7.5),
((SELECT id FROM inhabitant WHERE name='Limnophila sessiliflora'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Limnophila aromatica'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Rotala macrandra'),0,22,28,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Rotala wallichii'),0,22,28,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Rotala indica'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Ludwigia arcuata'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Ludwigia glandulosa'),0,22,28,6.0,7.5),
((SELECT id FROM inhabitant WHERE name='Proserpinaca palustris'),0,22,28,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Tonina fluviatilis'),0,24,28,5.5,6.5),
((SELECT id FROM inhabitant WHERE name='Myriophyllum tuberculatum'),0,22,28,6.0,7.0),
((SELECT id FROM inhabitant WHERE name='Cabomba caroliniana'),0,22,28,6.0,7.5);
